    ...
    return (
        <div className='flex flex-col m-20'>
            ...
            <div className='my-10'>
                ...
                {product?.serviceProviders?.map((user, id) => (
                    <div className='flex flex-col w-52 rounded-lg z-10 shadow-xl hover:z-20 hover:scale-105 hover:cursor-pointer'>
                        ...
                        <p className='text-left ml-2'>{user.name}</p>
                        <p className='text-left ml-2'>{user.email}</p>
                        <p className='text-left ml-2'>Price: $1200 per month</p>
                    </div>
